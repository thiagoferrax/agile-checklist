            ...
            <div className="row">
                <div className="col-sm-2 col-xs-6">
                    <div className="description-block border-right">
                        <button type="button" className="btn_ btn-default_" title="Next Checklist" onClick={() => this.nextChecklist()}><i className="fa fa-chevron-right"></i><i className="fa fa-chevron-right"></i></button>
